...
@WebServlet("/studentInquireServlet")

public class Stu_inquire extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/view/student/information/information.jsp").forward(request, response);
    }
