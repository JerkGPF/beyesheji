...
<div class="col-md-8">
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <h1 style="text-align: center;">申请缓考</h1>
            </div>
        </div>
        <div class="panel-body">
            <form name="reset" class="form-horizontal" role="form" action="<%=request.getContextPath()%>/postponeExamapplyServlet"   id="editfrom"
                ...
                <div class="col-sm-1"></div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">申请课程</label>
                    <div class="col-sm-5">
                ...
                <div class="col-sm-1"></div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">申请原因</label>
                    <div class="col-sm-5">
